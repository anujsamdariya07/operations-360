...
export default function DashboardLayout({
  ...
  const alerts = [
    {
      id: 1,
      type: 'inventory',
      message: "Product 'Box Type A' is below threshold quantity (5 remaining)",
    },
  ...
  return (
    <div className='mx-[0.8vw] flex min-h-screen flex-col'>
      {/* Header */}
            ...
            <ul className='space-y-2'>
              ...
              <li>
                <Link href='/dashboard/orders'>
                  <Button
                    variant={
                      isActive('/dashboard/orders') ? 'secondary' : 'ghost'
                    }
                    className='w-full justify-start'
                  >
                    <ClipboardList className='mr-2 h-5 w-5' />
              ...
              <li>
                <Link href='/dashboard/inventory'>
                  <Button
                    variant={
                      isActive('/dashboard/inventory') ? 'secondary' : 'ghost'
                    }
                    className='w-full justify-start'
                  >
              ...
              <li>
                <Link href='/dashboard/employees'>
                  <Button
                    variant={
                      isActive('/dashboard/employees') ? 'secondary' : 'ghost'
                    }
                    className='w-full justify-start'
                  >
              ...
              <li>
                <Link href='/dashboard/attendance'>
                  <Button
                    variant={
                      isActive('/dashboard/attendance') ? 'secondary' : 'ghost'
                    }
                    className='w-full justify-start'
                  >
              ...
              <li>
                <Link href='/dashboard/customers'>
                  <Button
                    variant={
                      isActive('/dashboard/customers') ? 'secondary' : 'ghost'
                    }
                    className='w-full justify-start'
                  >
